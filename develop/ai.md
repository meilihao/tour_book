...
- [AI-Agent-In-Action:AI Agent 开发实战](https://github.com/AIGeniusInstitute/AI-Agent-In-Action)
...
- [Rust 写一个 AI Coding Agent，能干 Claude Code 八成的事，小群开源了](https://mp.weixin.qq.com/s/zTvKyiJw4XHh7YwmMrAxhA)

	https://github.com/coder-brzhang/rust-agent, pri repo
- [learn-claude-code：从零开始动手实现 AI Agent](https://github.com/521xueweihan/HelloGitHub/blob/master/content/HelloGitHub119.md)
...
- [AQBot : 轻量级高性能跨平台AI对话 + AI网关桌面客户端](https://github.com/AQBot-Desktop/AQBot)
- [超级麦吉 3.0：全球首个企业级开源 AI Agent 平台](https://www.oschina.net/news/412265)
- [openagent](https://github.com/the-open-agent/openagent)

	Apache Casbin 原班人马用Go语言写了一只新龙虾
- [jcode](https://github.com/1jehuang/jcode)

	jcode 是终端 TUI 形态的 Coding Agent
...
## 知识库
- [个人知识库系统](https://github.com/usr80/knowledge-base)
