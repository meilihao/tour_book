...
- [知著 | 阿里智能APP关停，背后物联网云平台的淘汰赛还在继续](https://www.dtinsight.com.cn/nd.jsp?id=423)
- [DataEase 是一款开源、低代码、可视化的数据分析与大屏平台](https://mp.weixin.qq.com/s/zFUtRP06WNaQjwAj5kOr6g)
...
## 物模型
ref:
- [腾讯云:物模型定义](https://cloud.tencent.com/document/product/1081/103621)
    ...
    - [物模型协议](https://cloud.tencent.com/document/product/1081/34916)
        ...
        交互相关
    - [设备开发](https://cloud.tencent.com/document/product/1081/103622)

        topic命名
- [华为云: 创建产品](https://support.huaweicloud.com/api-iothub/iot_06_v5_0050.html)

    见service_capabilities

    - [Topic定义](https://support.huaweicloud.com/api-iothub/iot_06_v5_3004.html)

        topic命名
- [阿里云: 物模型管理的API](https://help.aliyun.com/zh/iot/developer-reference/list-of-operations-by-function)

    - [物模型管理 > ThingModelJson数据说明](https://help.aliyun.com/zh/iot/developer-reference/data-structure-of-thingmodeljson)
    - [物模型TSL字段说明](https://help.aliyun.com/zh/iot/user-guide/tsl-parameters)

        包含物模型json
    - [单个添加物模型](https://help.aliyun.com/zh/iot/user-guide/add-a-tsl-feature)
    - [数据格式](https://help.aliyun.com/zh/iot/user-guide/data-formats)

        topic及其他数据格式
    - [技术白皮书](https://help.aliyun.com/zh/iot/support/technical-whitepaper)
- [小米IOT](https://iot.mi.com/v2/new/doc/home)

    - [定义产品功能](https://iot.mi.com/v2/new/doc/resources-and-services/design/feature-define/feature-define)
    - [平台技术框架](https://iot.mi.com/v2/new/doc/introduction/tech_arch)
- [ucloud]()

    - [**方案架构**](https://www.ucloud.cn/site/solution/iot.html)
- [Amazon IoT]()

    - [迁移物联网平台至 Amazon IoT Core – 开启新的智能互联之旅](https://aws.amazon.com/cn/blogs/china/migrating-iot-platforms-to-amazon-iot-core/)

> 属性支持:
> 1. 阿里云: ARRAY、STRUCT、INT、FLOAT、DOUBLE、TEXT、DATE、ENUM、BOOL
> 1. 腾讯云: bool, int , string, float, enum, date, struct array
> 1. 华为云: int, long, decimal, string, datetime, json, enum, bool, []string
...
- iot
    ...
    - [**Hummingbird 蜂鸟 & 一个轻量级物联网平台**](https://doc.hummingbird.winc-link.com/)
        ...
        [golang源码](https://gitee.com/winc-link/hummingbird)

        演示地址：`https://demo.winc-link.com/, admin/123456`

        > 压测工具: [emqtt_bench](https://github.com/emqx/emqtt-bench), 用法见[蜂鸟IoT平台压测报告](https://doc.hummingbird.winc-link.com/guide/system/pressure.html)

    - [联犀](https://doc.unitedrhino.com/)
    ...
    - [iboot](https://gitee.com/iteaj/iboot)
    - [rust-iot-platform](https://github.com/iot-ecology/rust-iot-platform/tree/main)
    - [go-iot-platform](https://github.com/iot-ecology/go-iot-platform)
    - [rust-for-iot](https://github.com/Apress/rust-for-iot)
    - [gitee.com/code9095/gmv : 这是一个基于GB28181的视频监控实现](https://gitee.com/code9095/gmv)
    - [**工业软件 TOP 10**](https://www.oschina.net/news/400381)
    
    - 其他参考[from gitee](https://gitee.com/explore/topic/%E7%89%A9%E8%81%94%E7%BD%91)
    - [一个基于 Go-Zero 的工业级微服务脚手架](https://mp.weixin.qq.com/s/-L7IXkv9mGABahEIpwfImg)

        https://github.com/maomao94/zero-service
    - [TinyGW 是一款功能强大的物联网网关系统，专为工业设备数据采集与处理设计](https://gitee.com/illusoryNone/tiny-gw)
    - [蜂信物联](https://github.com/kerwincui/FastBee)
    - [dgiotcloud](https://github.com/dgiot/dgiot)

- 智慧能源管理系统（EMS）

    - [智碳能源管理系统](https://gitee.com/liulingling1993/zhitan-ems)

        手机号登入
    - [**MyEMS**](https://myems.io/)

        - [MyEMS能源管理系统软件管理员手册.pdf](https://myems.io/assets/files/myems-admin-manual-ef03762cc6c3f79bad4df88bcbfaf83d.pdf)
    - [农业岛智慧农业系统Java版](https://github.com/roinli/HUIZHI-MAPOS-cloud)
...
- 配套
    ...
    - [IoTOS 是一款高效实用 IoTCard 管理 & 运营系统](https://www.oschina.net/p/iotos)
...
### 大屏
- [运维机房动力环境监控大屏](https://mp.weixin.qq.com/s/DjxQ926ZypuOSf_8B43U_A)
