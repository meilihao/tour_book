...
- [TOTALLY Open™ Data Protection飞康CDP备份/容灾一体化解决方案](http://www.dostor.com/subject/falconstor100317/images/SC_090509.pdf)
  ...
  > maxuint64 = 18446744073709551615 = 2554-07-22 07:34:33.xxx, 足以应付key, 更佳是us(uint64)+version(uint16, 由cdp驱动生成), 支持时间超过9999年.

  > [falconstor cdp可在IO 级、百万分之一秒级实现数据历史追溯](http://www.falconstor.com.cn/detail/498.html)
