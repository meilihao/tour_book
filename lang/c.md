...
### static
1. 变量
静态全局变量: 作用域是从定义之处开始到文件结尾处, 通常声明在文件开头, 其他文件即使用extern声明都没法使用它.
...
2. 函数
函数前加static使得函数变成静态函数, 作用域是本文件, 即不同文件使用相同名称的静态函数互不影响, 因此它也被称为内部函数.
