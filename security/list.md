...
- [DH和ECDH](2017_09_18_001.md)
- [ECDH的设计与实现.pptx](ECDH的设计与实现.pptx)

## SSH
- [SSH 使用密钥登录并禁止口令登录实践](2015_07_08_001.md)
- [20 个 OpenSSH 最佳安全实践](https://linux.cn/article-9394-1.html)
...
- [OpenSSL与SSL数字证书概念贴](http://segmentfault.com/a/1190000002568019)
- [如何使用OpenSSL工具生成根证书与应用证书](http://blog.csdn.net/howeverpf/article/details/21622545)
...
- [谷歌两步验证系统的工作原理](http://www.infoq.com/cn/news/2014/09/system-verification)
